...
//$Header: /Conquest/Libs/Include/PersistMath.h 5     4/28/00 11:57p Rmarr $
...
typedef float           SINGLE;
	...
	struct PersistVector
	{
		...
		inline friend PersistVector operator + (const PersistVector & v1, const PersistVector & v2)
		{
			return PersistVector( v1.x + v2.x, v1.y + v2.y, v1.z + v2.z);
		}
	...
	struct PersistMatrix
	{
		...
		PersistMatrix(void) {}
		PersistMatrix(SINGLE a1, SINGLE a2, SINGLE a3,
					  SINGLE a4, SINGLE a5, SINGLE a6,
					  SINGLE a7, SINGLE a8, SINGLE a9)
		{
			e00 = a1; e01 = a2; e02 = a3;
			e10 = a4; e11 = a5; e12 = a6;
			e20 = a7; e21 = a8; e22 = a9;
		}
		...
		inline PersistMatrix get_transpose(void)
		{
			return PersistMatrix(
				e00, e10, e20,
				e01, e11, e21,
				e02, e12, e22
				);
		...
		{
			return PersistMatrix(
				m2.e00 * m1.e00 + m2.e01 * m1.e10 + m2.e02 * m1.e20,
	...
	struct PersistTransform
	{
		...
		inline friend PersistVector operator * (const PersistTransform & t, const PersistVector & v)
		{
			return PersistVector( (t.m * v) + t.v );
		}
    };
