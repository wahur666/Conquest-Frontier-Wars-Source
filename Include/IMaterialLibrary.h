...
struct IMaterialLibrary : public IDAComponent
{
	...
	virtual GENRESULT COMAPI create_material( const char *material_name, const char *material_class, IMaterialC **out_material ) = 0;
	virtual GENRESULT COMAPI add_material( const char *material_name, IMaterialC *material ) = 0;
	virtual GENRESULT COMAPI find_material( const char *material_name, IMaterialC **out_material ) = 0;
	...
	virtual GENRESULT COMAPI get_material( U32 num_material, IMaterialC **out_material ) = 0;
};
